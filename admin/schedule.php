    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            if ($_POST) {
                ...
                $sqlmain = "select schedule.day_of_week,schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  order by schedule.scheduledate desc";
            }
                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show All Doctors Available Sessions &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                        ...
                                        <td style="text-align:center;">
                                            ' . substr($scheduledate, 0, 10) . ' ' . substr($day, 0, 10) . ' ' . substr($scheduletime, 0, 5) . '
                                        </td>
                                        <td style="text-align:center;">
                                            ' . $nop . '
                                        </td>
        ...
        <center>
            ...
            <div style="display: flex; justify-content: center;">
                ...
                . '</td>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <form id="sessionForm" action="add-session.php" method="POST" class="add-new-form">
            ...
            echo '</select><br><br>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <select id="schedule_type" name="schedule_type" onchange="toggleScheduleType()" class="box">
                        ...
                        <tr id="single_date_picker">
                            <td class="label-td" colspan="2">
                                <input type="date" id="date" name="date" class="input-text" min="' . date('Y-m-d') . '" ><br>
                            </td>
                        </tr>

                        <!-- Weekly Recurrence Picker -->
                        <tr id="weekly_picker" style="display: none;">
                            <td class="label-td" colspan="2">
    ...
    <script>
        function toggleScheduleType() {
            ...
            if (scheduleType == 'single') {
                document.getElementById('single_date_row').style.display = 'table-row';
                document.getElementById('single_date_picker').style.display = 'table-row';
                document.getElementById('weekly_picker').style.display = 'none';
                dateInput.required = true;
                form.action = 'add-session.php';
            } else {
                document.getElementById('single_date_row').style.display = 'none';
                document.getElementById('single_date_picker').style.display = 'none';
                document.getElementById('weekly_picker').style.display = 'table-row';
                dateInput.required = false;
                form.action = 'week_session.php';
            }
        }
    </script>
</body>
