...
<body>
    ...
    $sqlmain = "SELECT *, specialties.sname AS sp ,schedule.day_of_week as dw 
                FROM schedule 
                INNER JOIN doctor ON schedule.docid = doctor.docid 
                INNER JOIN specialties ON doctor.specialties = specialties.id 
                WHERE schedule.scheduledate >= '$today' or schedule.scheduledate is NULL
    ...
    if ($_POST) {
        ...
        if (!empty($_POST["search"])) {
            ...
            $sqlmain = "SELECT * ,specialties.sname as sp,schedule.day_of_week as day_of_week
                            FROM schedule 
                            INNER JOIN doctor ON schedule.docid = doctor.docid 
                            INNER JOIN specialties ON doctor.specialties = specialties.id
                            WHERE schedule.scheduledate >= '$today' or schedule.scheduledate IS NULL
            ...
            <tr>
                ...
                <td>
                    <form action="" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor name or Email or Speciality" list="doctors" value="<?php echo $insertkey ?>">&nbsp;&nbsp;
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <div class="h4-search">
                                                                ' . $scheduledate .  $day . '<br>Starts: <b>@' . substr($scheduletime, 0, 5) . '</b> (24h)
                                                            </div>
                                                            <br>
